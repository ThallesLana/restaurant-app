<x-guest-layout>
    ...
    {{-- Start Banner Apresentation --}}
    <div class="container max-w-lg px-4 py-32 mx-auto text-left bg-center bg-no-repeat bg-cover md:max-w-none md:text-center"
      style="background: linear-gradient(rgba(24, 16, 16, 0.5), rgba(24, 16, 16, 0.5)), url('https://www.hotel-le-nouveau-monde.fr/wp-content/uploads/2019/01/restaurant-7-mers-bandeau.jpg')"
      >
        <h1
            ...
            <span class="inline md:block">Welcome To La Cuisine</span>
        </h1>
    ...
    {{-- End Banner Apresentation --}}

    {{-- Start Home/Story/Resume --}}
    ...
    <section class="py-20 bg-gray-50">
        <div class="container items-center max-w-6xl px-10 mx-auto sm:px-20 md:px-32 lg:px-16">
            <div class="flex flex-wrap items-center -mx-3">
                ...
                <div class="w-full px-3 mb-12 lg:w-1/2 order-0 lg:order-1 lg:mb-0"><img class="mx-auto sm:max-w-sm lg:max-w-full"
